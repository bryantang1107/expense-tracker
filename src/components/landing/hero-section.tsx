  ...
  return (
    <>
            ...
            <div className="flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
              <div className="flex w-full justify-between lg:w-auto">
                ...
                >
                  ...
                  />
                  <h1 className="text-2xl font-bold">GoExpense</h1>
                </Link>
      ...
      <main>
        ...
        <section
          id="hero"
          className="bg-muted/50 dark:bg-background overflow-hidden"
        >
          <div className="relative mx-auto max-w-5xl px-6 pt-28 lg:pt-24">
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              ...
              <p className="text-muted-foreground mx-auto my-8 max-w-2xl text-xl">
                A simple and intuitive way to manage your finances. See where
                your money goes with clear insights and helpful analytics.
              </p>
